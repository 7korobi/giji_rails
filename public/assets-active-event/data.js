...
this.JST["navi/messages"] = "<div class=\"message_filter\"><div class=\"log\"><div class=\"badge\" ng-class=\"page.of.prev.class\" ng-click=\"page.move(page.of.prev.val)\" ng-if=\"page\"> 前のページ</div></div></div><div class=\"message_filter\" from=\"event.messages\" logs=\"messages\"></div><div class=\"message_filter\"><div class=\"log\"><div class=\"badge\" ng-class=\"page.of.next.class\" ng-click=\"page.move(page.of.next.val)\" ng-if=\"page\"> 次のページ</div></div></div><div class=\"message_filter drag\" drag=\"event\" ng-repeat=\"event in floats\"><div class=\"contentframe\" logs=\"event.messages\"><div class=\"drag_head\"><span class=\"badge\" hogan-click=\"popup({{message.turn}}, &#39;{{message.logid}}&#39;)\">✘</span></div></div></div>";
...
this.URL = {
  "application": "http://7korobi.gehirn.ne.jp/assets-active-event",
